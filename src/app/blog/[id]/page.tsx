...
import CommitSection from "@/app/components/p";
...
export default function Product() {
  ...
  const [blog, setBlog] = useState<any>(null); // State to store blog data
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        {blog.content.map((section: any, index: number) => (
          <div key={index} className="mb-6">
            ...
            {section.image && (
              <Image className="w-full h-auto rounded-lg mb-4" width={100} height={100} src={section.image} alt="Generative AI" />
            )}
